C $Id: braket.for,v 1.8 1997/03/07 10:01:58 adarby Exp $
      SUBROUTINE DBRAKT ( ARRAY, N, X, I )
C
C VERSION
C     27-APR-00  AD  Original. DP version of BRAKET.
C
C DESCRIPTION
...
C ARGUMENTS
      ...
      DOUBLE PRECISION ARRAY(N) !  I  Data Array
      DOUBLE PRECISION X        !  I  Value to be bracketted
